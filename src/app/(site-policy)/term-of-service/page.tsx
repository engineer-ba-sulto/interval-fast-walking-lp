...
export default function TermsOfServicePage() {
  return (
    <>
      <PageHero title="利用規約" description="本サービスの利用規約について" />
        ...
        <div className="max-w-5xl mx-auto bg-white dark:bg-gray-800 p-8">
          <div className="prose prose-blue dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <p>
                この利用規約（以下「本規約」）は、本ウェブサイトおよび本アプリ「インターバル速歩」（以下、総称して「本サービス」といいます）の利用条件を定めるものです。ユーザーの皆様には、本規約に同意いただいた上で、本サービスをご利用いただきます。
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p>
                本サービスは、必要に応じて本規約を変更することができるものとします。変更後の利用規約は、本サービスが別途定める場合を除いて、本サービス上に表示した時点より効力を生じるものとします。
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p>
                本サービスに掲載されているコンテンツの著作権、商標権、その他の知的財産権は、本サービスまたは正当な権利者に帰属します。ユーザーは、法令で認められた範囲を超えて、これらの知的財産を使用することはできません。
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 mt-2 mb-4">
                <li>
                  本サービスは、本サービスの内容の正確性、完全性、有用性を保証するものではありません。
                </li>
                <li>
                  本サービスは、本サービスの中断、停止、終了、利用不能または変更によって生じたいかなる損害についても、一切の責任を負いません。
                </li>
                <li>
                  本サービスは、ユーザー間またはユーザーと第三者との間で生じた紛争等について、一切の責任を負いません。
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p>
                本サービスは、以下の場合には、事前の通知なく本サービスの全部または一部の提供を停止または中断することができるものとします：
              </p>
              <ul className="list-disc pl-6 mt-2 mb-4">
